...
%	\textbf{\large Diferencias de Gr\'aficos}
	...
	\begin{figure}[H]
		\centering
		\subfloat{\includegraphics[scale = 0.3]{grafico28}}
		\hfill
		\subfloat{\includegraphics[scale = 0.3]{grafico29}}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\subfloat{\includegraphics[scale = 0.4]{grafico30}}
		\hfill
		\subfloat{\includegraphics[scale = 0.4]{grafico31}}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\subfloat{\includegraphics[scale = 0.4]{grafico32}}
		\hfill
		\subfloat{\includegraphics[scale = 0.4]{grafico33}}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\subfloat{\includegraphics[scale = 0.4]{grafico34}}
		\hfill
		\subfloat{\includegraphics[scale = 0.4]{grafico35}}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\subfloat{\includegraphics[scale = 0.4]{grafico36}}
		\hfill
		\subfloat{\includegraphics[scale = 0.4]{grafico37}}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\subfloat{\includegraphics[scale = 0.45]{grafico38}}
		\hfill
		\subfloat{\includegraphics[scale = 0.45]{grafico39}}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\subfloat{\includegraphics[scale = 0.45]{grafico40}}
		\hfill
		\subfloat{\includegraphics[scale = 0.45]{grafico41}}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\subfloat{\includegraphics[scale = 0.4]{grafico42}}
		\hfill
		\subfloat{\includegraphics[scale = 0.4]{grafico43}}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\subfloat{\includegraphics[scale = 0.45]{grafico44}}
		\hfill
		\subfloat{\includegraphics[scale = 0.45]{grafico45}}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\subfloat{\includegraphics[scale = 0.4]{grafico46}}
		\hfill
		\subfloat{\includegraphics[scale = 0.4]{grafico47}}
	\end{figure}
	
	\begin{figure}[H]
		\centering
		\subfloat{\includegraphics[scale = 0.45]{grafico48}}
		\hfill
		\subfloat{\includegraphics[scale = 0.45]{grafico49}}
	\end{figure}
